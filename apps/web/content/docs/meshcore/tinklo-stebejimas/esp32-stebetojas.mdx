...
Įrenginio vardą rekomenduojama nustatyti pagal vietą kaip retransliatoriaus vardą su dviejų simbolių ID ir sufiksu `OBS`. Pavyzdžiui: `LT-KM Aleksotas FF OBS`. Įrenginiui su GPS vieta vardas negali viršyti 24 UTF-8 baitų.
...
set mqtt2.port 443
set mqtt2.audience mqtt-mc.atvirastinklas.lt # JWT Autentifikacija, naudos kriptografinį žetoną naudojant privatų raktą
```
