...
6. Pasirinkite įrenginį, kurį norite atnaujinti. Bluetooth pavadinimas bus su `DFU` tekstu arba jeigu padarėte [bootloader fix](#bootloader-atnaujinimas-ota-fix) pagal įrenginį:
